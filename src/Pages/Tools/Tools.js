...
import Img5 from '../../assets/tools/slejven-djurakovic-0uXzoEzYZ4I-unsplash.jpg';

const Tools = () => {
    return (
        <div className='bg-info border-t border-neutral px-20'>
            ...
            <div className='pb-10'>
                <div className='md:mt-16 mt-10 mb-5 grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-between gap-5'>
                    ...
                    <div className="bg-info text-neutral border border-secondary">
                        <figure><img src='https://static-01.daraz.com.bd/p/9cb096b4fe0697ebfdb5206ec6e7bf9a.jpg' className="w-[100%]" alt="Shoes" /></figure>
                        <div className="card-body p-5">
                            <h2 className="card-title">
                                Intel® Processor E5700
                                <div className="badge badge-secondary">NEW</div>
