    ...
    return (
        <div className='w-full p-10 h-full'>
            ...
            <table className="table w-full">
                ...
                <tbody>
                    {
                        tools ? tools?.map(tool => <tr key={tool?._id}>
                            <td>
                            ...
                            <td>{tool?.quantity}</td>
                            <th>
                                <button onClick={() => deleteOrder(tool._id)} className="btn btn-error btn-sm lg:table-cell hidden mr-2 w-20">Delete</button>
                                <Link to={`/dashboard/checkOut/${tool._id}`}><button className="btn btn-secondary btn-sm lg:table-cell hidden w-20">Pay</button></Link>
